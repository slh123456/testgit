...
jq(function () {
    ...
    a.setTop();
//    a.addItem("<a class='research' target='_blank' href=''><b></b>下载帮助</a>");
...
jq.ajax({
    ...
    data: "text=" +escape(nahled_text) + "",
        ...
        var nahled_text = jq("#text").attr("value");
	        ...
	        window.open("/query/"+nahled_text+"/classID=13","_blank");
            return false;
